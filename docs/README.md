...
| I want to… | Read |
|---|---|
| turn my website into an app **without installing anything** | [getting-started.md](./getting-started.md#the-no-terminal-way) |
| build it on my own computer | [getting-started.md](./getting-started.md#the-local-way) |
